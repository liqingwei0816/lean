...
public class OperatorAop {
     ...
     * 添加人添加切面
     */
    @Around("execution(public * com.*.mapper.*.*.insert*(..) )" +
            "||execution(public * com.*.mapper.*.insert*(..) )")
     ...
     * 修改人人添加切面
     */
    @Around("execution(public * com.*.mapper.*.*.update*(..) )" +
            "||execution(public * com.*.mapper.*.update*(..) )")
